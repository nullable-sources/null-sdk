...
#define math_define_vec2_function(name, function, ...)															\
	...
	static vec2_t<coordinates_t> name##(impl_math_arg(impl_math_type_define_args(vec2, __VA_ARGS__))) function	\

#define math_define_vec3_function(name, function, ...)															\
	math_define_templates(vec3_t, coordinates_t)																\
	static vec3_t<coordinates_t> name##(impl_math_arg(impl_math_type_define_args(vec3, __VA_ARGS__))) function	\

#define math_define_vec4_function(name, function, ...)															\
	math_define_templates(vec4_t, coordinates_t)																\
	static vec4_t<coordinates_t> name##(impl_math_arg(impl_math_type_define_args(vec4, __VA_ARGS__))) function	\

#define math_define_rect_function(name, function, ...)														\
	math_define_templates(rect_t, corners_t)																\
	static rect_t<corners_t> name##(impl_math_arg(impl_math_type_define_args(rect, __VA_ARGS__))) function	\
