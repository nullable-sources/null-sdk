...
public:
    ...
    rect_t(corners_t a, corners_t size, null::e_rect_origin _origin) : min{ a } { origin(_origin, size); }
    rect_t(const vec2_t<corners_t>& a, const vec2_t<corners_t>& size, null::e_rect_origin _origin) : min{ a } { origin(_origin, size); }
