...
namespace ntl::sdk {
    ...
    public:
        NULLSDK_FAST_OPS_STRUCTURE_CONVERT_OPERATOR(inline constexpr, , vec3_t<channel_t>() const, vec3_t<channel_t>, , r, g, b);
        NULLSDK_FAST_OPS_STRUCTURE_CONVERT_OPERATOR(inline constexpr, , vec4_t<channel_t>() const, vec4_t<channel_t>, , r, g, b, a);
        NULLSDK_FAST_OPS_STRUCTURE_CONVERT_OPERATOR(inline constexpr, , NULLSDK_FAST_OPS_ARGS_PACK(std::tuple<channel_t, channel_t, channel_t, channel_t>)() const, std::make_tuple, , r, g, b, a);
        ...
        NULLSDK_FAST_OPS_STRUCTURE_ALL_PREFIX_OPERATORS(inline constexpr, r, g, b, a);
        NULLSDK_FAST_OPS_STRUCTURE_ALL_POSTFIX_OPERATORS(inline constexpr, r, g, b, a);

        NULLSDK_FAST_OPS_STRUCTURE_ALL_ARITHMETIC_OPERATORS(inline constexpr, NULLSDK_FAST_OPS_ARGS_PACK(template <typename self_t, typename other_t>), const i_color<other_t>&, RHS_FIELD, r, g, b, a);
        NULLSDK_FAST_OPS_STRUCTURE_ALL_ARITHMETIC_OPERATORS(inline constexpr, template <typename self_t>, channel_t, RHS_VALUE, r, g, b, a);

        NULLSDK_FAST_OPS_STRUCTURE_EQUAL_OPERATOR(inline constexpr, template <typename other_t>, const i_color<other_t>&, RHS_FIELD, r, g, b, a);
        NULLSDK_FAST_OPS_STRUCTURE_EQUAL_OPERATOR(inline constexpr, , channel_t, RHS_VALUE, r, g, b, a);

        NULLSDK_FAST_OPS_STRUCTURE_ALL_COMPARISON_OPERATORS(inline constexpr, NULLSDK_FAST_OPS_ARGS_PACK(template <typename self_t, typename other_t>), const i_color<other_t>&, RHS_FIELD, r, g, b, a);
        NULLSDK_FAST_OPS_STRUCTURE_ALL_COMPARISON_OPERATORS(inline constexpr, template <typename self_t>, channel_t, RHS_VALUE, r, g, b, a);
    };
}