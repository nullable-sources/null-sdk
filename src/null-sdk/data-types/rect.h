...
public:
    ...
    static constexpr vec2_t<float> scale_from_origin(null::e_rect_origin origin) {
...
public:
    ...
    inline constexpr rect_t(corner_t a, corner_t size, const null::e_rect_origin& _origin) : min(a) { origin(_origin, size); }
    inline constexpr rect_t(const vec2_t<corner_t>& a, const vec2_t<corner_t>& size, const null::e_rect_origin& _origin) : min(a) { origin(_origin, size); }
    ...
    inline constexpr rect_t(const type_t& value) { *this = null::compatibility::data_type_converter_t<type_t, rect_t<corner_t>>::convert(value); }
...
public:
    ...
    template <typename self_t> inline constexpr auto&& scale(this self_t&& self, null::e_rect_origin _origin, const vec2_t<float>& _scale) { return self.scale(scale_from_origin(_origin), _scale); }
    ...
    inline constexpr vec2_t<corner_t> origin(null::e_rect_origin _origin) const { return origin(scale_from_origin(_origin)); }
    template <typename self_t> inline constexpr auto&& origin(this self_t&& self, null::e_rect_origin _origin, const vec2_t<corner_t>& size) { return self.origin(scale_from_origin(_origin), size); }
...
public:
    ...
    inline constexpr operator type_t() const { return null::compatibility::data_type_converter_t<rect_t<corner_t>, type_t>::convert(*this); }
