...
#define impl_fast_ops_create_op(return_t, op, args, op_fn, ...) __VA_ARGS__ return_t operator op##args op_fn
...
#define fast_ops_structure_convert_operator(templates, covnerting_t, construct, member_op, ... /*members*/)  \
