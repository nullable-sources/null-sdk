...
namespace memory {
    ...
    resource_t* c_module::find_resource(const std::string_view& name, const std::string_view& type) {
    ...
    c_dll::i_export* c_dll::find_stored_export(const std::string_view& _name) {
